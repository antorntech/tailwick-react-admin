  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/api/v1/maincontacts/add",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div>
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold">Add Contact Details</h1>
          <p className="text-sm text-gray-500">
            You can add contact details from here.
          </p>
        </div>
      </div>
